...
net.addLayer('fc1',fc1Block,{'x34'},{'fc1'},{'fc1f'});
...
net.addLayer('dropout',dagnn.DropOut('rate',0.8),{'fc1_1bnx'},{'fc1_1bnxd'});


%----------------------char cnn----------------------
% input is 1*32*20074*16
fc2Block = dagnn.Conv('size',[1 1 7263 300],'hasBias',true,'stride',[1,1],'pad',[0,0,0,0]);
...
poolBlock = dagnn.Pooling('poolSize',[1 14]);
...
net.addLayer('dropout2',dagnn.DropOut('rate',0.8),{'fc5_2bnx'},{'fc5_2bnxd'});

%----------------------add share layer----------------------
%1

fc_imgBlock = dagnn.Conv('size',[1 1 2048 11003],'hasBias',true,'stride',[1,1],'pad',[0,0,0,0]);
net.addLayer('fc_img',fc_imgBlock,{'fc1_1bnxd'},{'prediction_img'},{'fcsharef','fcshareb'});
...
%2
fc_txtBlock = dagnn.Conv('size',[1 1 2048 11003],'hasBias',true,'stride',[1,1],'pad',[0,0,0,0]);
net.addLayer('fc_txt',fc_txtBlock,{'fc5_2bnxd'},{'prediction_txt'},{'fcsharef','fcshareb'});
