function net = vgg_2stream_small4x()
...
net.addLayer('conv7a',conv7aBlock,{'conv6_1ax'},{'predictiona'},{'ca7f','ca7b'});
net.addLayer('bn7a',dagnn.BatchNorm(),{'predictiona'},{'predictiona_bn'},{'bna_f','bna_b','bna_c'});
lossBlock = dagnn.Loss('loss', 'softmaxlog');%label_smooth
