...
for t=1:params.batchSize:numel(subset)
    ...
    for s=1:params.numSubBatches
        ...
        %make batchsize is even
        if( mod(batchEnd-batchStart+1,2)==1)
            batchEnd = batchEnd-1;
        ...
        %net_tmp = dagnn.DagNN.loadobj(net.saveobj());
        inputs = params.getBatch(params.imdb, batch,net,opts) ;
        ...
        if params.prefetch
            ...
            params.getBatch(params.imdb, nextBatch,net,opts) ;
        end
