to compile:
---------------
mex LMMMex.cpp LMM.cpp UtilLMM.cpp COMPFLAGS="/openmp $COMPFLAGS" CXXFLAGS="\$CXXFLAGS -std=c++0x" LDFLAGS="\$LDFLAGS -fopenmp"
mex FVMex.cpp FV.cpp LMM.cpp UtilLMM.cpp COMPFLAGS="/openmp $COMPFLAGS" CXXFLAGS="\$CXXFLAGS -std=c++0x" LDFLAGS="\$LDFLAGS -fopenmp"
